...
public class ResideMenu extends FrameLayout{
     ...
     * @param direction
     */
    public void addMenuLayout(ViewGroup menuLayout, int direction){
        if (direction == DIRECTION_LEFT){
            
            layoutLeftMenu.addView(menuLayout);
        }else{
            
            layoutRightMenu.addView(menuLayout);
        }
    }
