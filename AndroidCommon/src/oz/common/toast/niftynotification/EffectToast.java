package oz.common.toast.niftynotification;
/*
...
public class EffectToast {
    ...
    private EffectToast(Activity activity, CharSequence text, Effects effects, ViewGroup viewGroup) {
    ...
    private EffectToast(Activity activity, CharSequence text, Effects effects, ViewGroup viewGroup, Configuration configuration) {
    ...
    public static EffectToast build(Activity activity, CharSequence text, Effects effects, int viewGroupResId) {
        return new EffectToast(activity, text, effects, (ViewGroup) activity.findViewById(viewGroupResId));
    }

    public static EffectToast build(Activity activity, CharSequence text, Effects effects, int viewGroupResId, Configuration configuration) {
        return new EffectToast(activity, text, effects, (ViewGroup) activity.findViewById(viewGroupResId), configuration);
    }

    
    public static EffectToast build(Activity activity, CharSequence text, Effects effects) {
        return new EffectToast(activity, text, effects, (ViewGroup) activity.findViewById(niftyNotificationLayoutId(activity)));
    }

    
    public static EffectToast build(Activity activity, CharSequence text, Effects effects, Configuration configuration) {
        return new EffectToast(activity, text, effects, (ViewGroup) activity.findViewById(niftyNotificationLayoutId(activity)), configuration);
    }
    ...
    /**
     * 
     * Get NiftyNotification Layout Id;
     * 
     * */  
    
    private static int niftyNotificationLayoutId(Context context) {

    	LinearLayout notificationLayout = new LinearLayout(context);

    	notificationLayout.setId(0x123456);
		
		return notificationLayout.getId();
    ...
    public EffectToast setIcon(Drawable iconDrawable){
        this.iconDrawable=iconDrawable;
        return this;
    }

    public EffectToast setIcon(int iconRes){
        this.iconRes=iconRes;
        return this;
    }

    public EffectToast setOnClickListener(View.OnClickListener onClickListener) {
